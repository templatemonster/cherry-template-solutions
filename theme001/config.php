...
$GLOBALS['TPL_CFG']['Name'] = 'Print Store';
...
$GLOBALS['TPL_CFG']['DemoStore'] = "http://print-store-demo.mybigcommerce.com";

// Is theme enabled? (i.e. visible in Theme Store)
$GLOBALS['TPL_CFG']['Enabled'] = Store_Feature::isEnabled('PrintStoreTheme');
